...
public class ArticleAgentOrchestrator {
    ...
    private static final String KEY_REFERENCE_SUMMARY = "referenceSummary";
    ...
    public void executePhase1_GenerateTitles(ArticleState state, Consumer<String> streamHandler) {
        ...
        StreamHandlerContext.set(state.getTaskId(), streamHandler);
        ...
        try {
            ...
            inputs.put(KEY_REFERENCE_SUMMARY, state.getReferenceSummary());
            ...
            StreamHandlerContext.clear(state.getTaskId());
        }
    }
    ...
    private KeyStrategyFactory createKeyStrategyFactory() {
        return () -> {
            ...
            strategies.put(KEY_REFERENCE_SUMMARY, new ReplaceStrategy());
